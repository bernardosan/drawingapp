...
class MainActivity : AppCompatActivity() {
    ...
    private var btnBrush: ImageView? = null
    private var btnUndo: ImageView? = null
    private var btnredo: ImageView? = null
    private var btngallery: ImageView? = null
        ...
        registerForActivityResult(ActivityResultContracts.RequestMultiplePermissions()) { permissions ->
            permissions.entries.forEach {
                ...
                if (isGranted ) {
                   ...
                   // if (perMissionName == Manifest.permission.READ_EXTERNAL_STORAGE) Toast.makeText(this@MainActivity, "Oops you just denied the permission.", Toast.LENGTH_LONG).show()
                }
            }
    ...
    private val localStorageLauncher : ActivityResultLauncher<String> = registerForActivityResult(ActivityResultContracts.RequestPermission()){
        ...
        Toast.makeText(this, "Granted permission of storage", Toast.LENGTH_SHORT).show()
        val pickIntent = Intent(Intent.ACTION_PICK,MediaStore.Images.Media.EXTERNAL_CONTENT_URI)
        openGalleryLauncher.launch(pickIntent)

    } else {
        Toast.makeText(this, "Denied Ppermission of storage", Toast.LENGTH_SHORT).show()
    }
    }
